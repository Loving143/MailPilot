...
public class EmailConstants {
	...
	public static final String SUBJECT =
			"Application for Java Developer Position";
			...
			<p>
			I regularly practice problem-solving on <b>LeetCode</b> to sharpen my skills.<br>
			You can view my profile here:
			<a href="https://leetcode.com/u/Loving_121/">LeetCode Profile</a>
			</p>
			...
			<p>
			I would be grateful for an opportunity to showcase my abilities and discuss how I can contribute to your team.<br>
			Please find my <b>resume attached</b> for your reference.
			</p>
